...
function operateFormatter1(value, row, index) {
    return [
        '<a class="update" href="./UpdateAssignment.html" title="Edit">',
...
function operateFormatter2(value, row, index) {
    return [
        '<a class="remove" href="./TargetValuesList.html" title="Target Values List">',
...
$(function () {
    $appendButton.click(function () {
        ...
        window.location = "./NewAssignment.html";
    });
});
...
$(function () {
    $backButton.click(function () {
        // Create a new item if user clicks on append button
        window.location = "./TargetValuesAssignmentList.html";    });
});
